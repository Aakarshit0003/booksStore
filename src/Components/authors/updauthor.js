...
import { updAuthor } from '../../actions/authorsAction'
...
Update.propTypes = {
    updAuthor: propTypes.func.isRequired
}
export default connect(null, { updAuthor })(Update);